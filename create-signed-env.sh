...
mkdir -p vendor/clover-priv
mv ~/.android-certs vendor/clover-priv/keys
echo "PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/clover-priv/keys/releasekey" > vendor/clover-priv/keys/keys.mk
cat <<EOF > vendor/clover-priv/keys/BUILD.bazel
filegroup(
...
echo "Done! Now build as usual. If builds aren't being signed, add '-include vendor/clover-priv/keys/keys.mk' to your device mk file"
echo "Make copies of your vendor/clover-priv folder as it contains your keys!"
sleep 3
